        ...
        <table class="text-left w-full">
            <thead class="bg-black flex text-white w-full">
                <tr class="flex w-full mb-4">
                    ...
                    <th class="p-4 w-1/4">five</th>
                    <th class="p-4 w-1/4">Six</th>
                    <th class="p-4 w-1/4">Seven</th>
                </tr>
            </thead>
            ...
            <tbody class="bg-grey-light flex flex-col items-center justify-between overflow-y-scroll w-full"
                ...
                <tr class="flex w-full mb-4">
                    ...
                    <td class="p-4 w-1/4">croco</td>
                    <td class="p-4 w-1/4">shark</td>
                    <td class="p-4 w-1/4">cow</td>
                </tr>
                <tr class="flex w-full mb-4">
                    <td class="p-4 w-1/4">Dogs</td>
                    <td class="p-4 w-1/4">Cats</td>
