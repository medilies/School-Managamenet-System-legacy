...
<form action={{route('clients.store')}} method="post" class="w-full  border-2 p-4 " >
    ...
    <div class="flex flex-wrap -mx-3 mb-6 ">
        ...
        <div  class="w-full md:w-1/2  px-3 mt-2" >
            <label class="block  tracking-wide text-gray-700 text-xs font-bold mb-2 " for="ar_fname" >
                الاسم
              </label>
        ...
        <div  class="w-full md:w-1/2  px-3 mt-2" >
            <label class="block  tracking-wide text-gray-700 text-xs font-bold mb-2 " for="ar_lname" >
                اللقب
              </label>
        ...
        <div  class="w-full md:w-1/2  px-3 mt-2" >
            <label class="block  tracking-wide text-gray-700 text-xs font-bold mb-2 " for="profession" >
                Profession
              </label>
