<div class="flex flex-wrap justify-around items-end mx-2">
    ...
    <x-forms.input name="fname" type="text"
        ...
        <x-slot:label_text> Prénom
            @isset($student_data->fname)
                ( {{ $student_data->fname }} )
            @endisset
        </x-slot:label_text>
    </x-forms.input>
    ...
    <x-forms.input name="lname" type="text"
        ...
        <x-slot:label_text> Nom
            @isset($student_data->lname)
                ( {{ $student_data->lname }} )
            @endisset
        </x-slot:label_text>
    </x-forms.input>
    ...
    <x-forms.input name="ar_fname" type="text"
        ...
        <x-slot:label_text> الاسم
            @isset($student_data->ar_fname)
                ( {{ $student_data->ar_fname }} )
            @endisset
        </x-slot:label_text>
    </x-forms.input>
    ...
    <x-forms.input name="ar_lname" type="text"
        ...
        <x-slot:label_text> اللقب
            @isset($student_data->ar_lname)
                ( {{ $student_data->ar_lname }} )
            @endisset
        </x-slot:label_text>
    </x-forms.input>
    ...
    <x-forms.input name="bday" type="date"
        ...
        <x-slot:label_text> Date de naissance
            @isset($student_data->bday)
                ( {{ $student_data->bday }} )
            @endisset
        </x-slot:label_text>
    </x-forms.input>
    ...
    <x-forms.input name="bplace" type="text"
        ...
        <x-slot:label_text> Lieu de naissance
            @isset($student_data->bplace)
                ( {{ $student_data->bplace }} )
            @endisset
        </x-slot:label_text>
    </x-forms.input>
    ...
    @empty($update_form)
        ...
        <x-forms.input name="ex_registration_establishment" type="text">
            <x-slot:label_text> L'ancien établissement </x-slot:label_text>
        </x-forms.input>
