...
<body class="font-sans antialiased">
    ...
    <div class="flex h-screen">
        ...
        <aside class="bg-blue-900 h-screen w-72 p-4 shadow-md relative">
            ...
            <div class="m-2 flex flex-wrap items-center">
                ...
                <div class="text-white text-lg font-bold flex-1">
    ...
    <footer
        class="absolute bottom-0 right-0 bg-gray-400 bg-opacity-80 text-gray-100 p-1 w-96 rounded-tl-xl text-xs text-right">
        &copy;2022 <span class="font-bold"> Boudouma Mohamed Ilies </span> & Abdi Mohamed - Elhayat School
    </footer>
</body>
